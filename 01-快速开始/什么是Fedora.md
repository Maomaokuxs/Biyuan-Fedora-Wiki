...
大多数衍生版本都基于某个特定版本（通常是 Fedora 工作站版），并使用相应的安装流程。大体分为 Editions，Spins，Atomic Desktops 和 Labs 四个类别，每一类包含数个发行版，详细说明请跳转至 [Fedora-各种发行版的详细说明](../99-其他/Fedora-各种发行版的详细说明.md)。
